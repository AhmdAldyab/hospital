...
<div class="row">
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form action="{{ route('nurse.update','test') }}" method="POST" autocomplete="off"
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" value="{{ $nurse->getTranslation('name','ar') }}" name="name_ar"
                                required>
                        </div>
                        <div class="form-group col">
                            <label for="inputEmail4"> {{ trans('doctor.name_en') }}</label>
                            <input type="text" class="form-control" value="{{ $nurse->getTranslation('name','en') }}" name="name_en"
                                required>
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <input type="email" class="form-control" value="{{ $nurse->email }}" name="email"
                                required>
                        </div>
                        <div class="form-group col">
                            <label for="inputEmail4"> {{ trans('doctor.number_phone') }}</label>
                            <input type="number" class="form-control" value="{{ $nurse->number_phone }}"
                                name="number_phone" required>
                        </div>
                        <div class="form-group col">
                            <label for="inputEmail4"> {{ trans('doctor.date_hiring') }}</label>
                            <input type="date" class="form-control" value="{{ $nurse->date_hiring }}"
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select name="specialization_id" class="custom-select mr-sm-2" required>
                                <option selected value="{{ $nurse->specialization_id }}" >{{ $nurse->specialization->name }}</option>
                        ...
                        <div class="form-group col">
                            ...
                            <select name="section_id" class="custom-select mr-sm-2" required>
                                <option selected value="{{ $nurse->specialization_id }}" >{{ $nurse->section->name }}</option>
                        ...
                        <div class="form-group col">
                            ...
                            <select name="gender_id" class="custom-select mr-sm-2" required>
                                <option selected value="{{$nurse->gender_id}}" >{{ $nurse->gender->name }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="adrees" class="form-control" value="{{ $nurse->adrees }}"
                            required>
                    </div>
                    <div class="form-group">
