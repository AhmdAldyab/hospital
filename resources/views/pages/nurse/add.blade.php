...
<div class="row">
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form action="{{ route('nurse.store') }}" method="POST" autocomplete="off"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            <label for="statusSpech">{{ trans('doctor.section') }}</label>
